"""Follow-Up Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Sales follow-up agent that generates timely follow-up messages, manages multi-touch sequences, identifies re-engagement opportunities for stale deals, and tracks follow-up effectiveness.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
