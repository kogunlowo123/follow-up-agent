"""Follow-Up Agent - Domain-Specific Connectors."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with Follow-Up Agent."""
...
class HubspotConnector:
    """Domain-specific connector for hubspot integration with Follow-Up Agent."""
...
class OutreachConnector:
    """Domain-specific connector for outreach integration with Follow-Up Agent."""
...
class ApolloConnector:
    """Domain-specific connector for apollo integration with Follow-Up Agent."""
...
class LinkedinSalesNavigatorConnector:
    """Domain-specific connector for linkedin sales navigator integration with Follow-Up Agent."""
